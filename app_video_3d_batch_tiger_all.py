...
image_dir = "/home/yinzijin/experiments/gaojiayi/DragonDiffusion_inflation_ldm/walkdog/walk_dog512/raw_video/"
image_list = os.listdir(image_dir)
# image_list = list(translate_dict.keys())
...
save_dir = './result/output_video_dog2tiger_crop_notemp_guidance30_0.15guidanceedit8e-2edit_difttemporal1.5_repeat20_estimator3d_diffpromptinv_all/'

if not os.path.exists(save_dir):
    os.mkdir(save_dir)
mask_dir = "/home/yinzijin/experiments/gaojiayi/DragonDiffusion_inflation_ldm/walkdog/walk_dog512/raw_video_mask/"
ref_dir = "/home/yinzijin/experiments/gaojiayi/DragonDiffusion_inflation_ldm/walkdog/whitetiger_1.5_output_crop_copy&paste/"
maskref_dir = "/home/yinzijin/experiments/gaojiayi/DragonDiffusion_inflation_ldm/walkdog/whitetiger_1.5_output_crop_copy&paste_mask/"
# if not os.path.exists(save_dir):
#     os.mkdir(save_dir)
prompt = "a person and a white tiger"
