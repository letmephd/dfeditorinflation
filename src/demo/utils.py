...
def segment_with_points(
    ...
    if len(global_points) == 0:
        ...
        print(image_with_point, original_image, None, global_points, global_point_label, img_direction, original_image)
        ...
        # print(image_with_point, original_image, mask_image, global_points, global_point_label, img_direction, original_image)
...
def get_point_move_new(original_image, img, selected_points):
    if original_image is not None:
        img = original_image.copy()
    else:
        original_image = img.copy()
    ...
    for idx, point in enumerate(selected_points):
        ...
        points = [] # 相当于只会动img，而不会动原图
    img = np.array(img)
    return img, original_image, selected_points
