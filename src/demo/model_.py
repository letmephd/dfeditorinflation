...
class DragonModels():
    ...
    def run_move(self, original_image, mask, mask_ref, prompt, selected_points ,resize_scale=1, w_edit=4, w_content=0.1, w_contrast=0.2, w_inpaint=0.8, seed=42, guidance_scale=4, energy_scale=0.5, max_resolution=768, SDE_strength=0.4, ip_scale=None):
        #ref 和 mask ref 应该都是不需要的
        # 只有一张original_image
        # 关键就是搞清mask 和 selected_points
        # img 可能就得是numpy的形式了
