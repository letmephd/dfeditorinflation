...
from ..utils.image_util import save_gif_mp4_folder_type
...
# class DragonUNet3DConditionModel(UNet3DConditionModel):    
class DragonUNet3DConditionModel(ModelMixin, ConfigMixin,UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        inversion: bool = True,
        no_save: bool = False,
        samplestep: Union[torch.Tensor, float, int]=None,
        prompt = None,
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                ...
                up_attention_maplist=up_attention_maplist + attention_map
            else:
        ...
        if samplestep%10==0 and no_save==False:
            ...
            #     save_gif_mp4_folder_type(output_list, video_save_path)
            # out = out[:,:,:,:8]
            # print("unet3d condition_afterxs")
            # from IPython import embed;embed()
