...
class DDIMInversion:
    ...
    def get_noise_pred_single(self, latents, t, context,samplestep = None):
        noise_pred = self.model.unet(latents, t, encoder_hidden_states=context,inversion = True, samplestep=samplestep,prompt = self.prompt)["sample"]
        return noise_pred
    ...
    def ddim_loop(self, latent):
        ...
        for i in tqdm(range(self.NUM_DDIM_STEPS)):
            ...
            noise_pred = self.get_noise_pred_single(latent, t, cond_embeddings,samplestep=i)
